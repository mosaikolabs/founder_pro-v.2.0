...
const AC011LegacyImpact = () => {
  ...
  return (
    <ACModuleTemplate
      ...
      moduleDescription="Optimiza el impacto y legado duradero de tu startup"
      kpiData={kpiData}
      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-soft border border-gray-100">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-text-primary mb-2 flex items-center">
            <Icon name="Heart" size={28} className="text-primary-500 mr-3" />
            Matriz Legacy Impact
          </h2>
          <p className="text-text-secondary">
            Control integral de optimización del impacto y legado.
          </p>
        </div>
...
export default AC011LegacyImpact; 