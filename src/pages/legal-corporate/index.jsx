...
const AC002LegalCorporate = () => {
  ...
  return (
    <ACModuleTemplate
      moduleId="AC-002"
      moduleName="Legal & Corporativo"
      moduleDescription="Establece la estructura legal sólida y cumplimiento regulatorio para tu startup"
      kpiData={kpiData}
      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-soft border border-gray-100">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-text-primary mb-2 flex items-center">
            <Icon name="Scale" size={28} className="text-primary-500 mr-3" />
            Matriz Legal & Corporativa
          </h2>
          <p className="text-text-secondary">
            Control integral de la estructura legal y cumplimiento regulatorio.
          </p>
        </div>
        
        <div className="grid grid-cols-5 gap-6">
          {/* Same phase timeline pattern */}
          {[
...
export default AC002LegalCorporate; 