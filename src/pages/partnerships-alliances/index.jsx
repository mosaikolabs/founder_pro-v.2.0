...
const AC008PartnershipsAlliances = () => {
  const kpiData = [
  ...
  return (
    <ACModuleTemplate
      moduleId="AC-008"
      moduleName="Partnerships & Strategic Alliances"
      moduleDescription="Desarrolla alianzas estratégicas para acelerar el crecimiento de tu startup"
      kpiData={kpiData}
      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-soft border border-gray-100">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-text-primary mb-2 flex items-center">
            ...
            Matriz Partnerships & Alliances
          </h2>
          <p className="text-text-secondary">
            Control integral de alianzas estratégicas y partnerships.
          </p>
        </div>
...
export default AC008PartnershipsAlliances; 