...
const ScalingGrowthOptimization = () => {
  const kpiData = [
    { title: "Overdue Tasks", value: "5", subtitle: "Tasks past due date", color: "error", icon: "AlertTriangle" },
  ...
  return (
    <ACModuleTemplate
      moduleId="AC-009"
      moduleName="Scaling Growth Optimization"
      moduleDescription="Optimiza el scaling y growth para lograr crecimiento exponencial sostenible"
      kpiData={kpiData}
      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-soft border border-gray-100">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-text-primary mb-2 flex items-center">
            <Icon name="TrendingUp" size={28} className="text-primary-500 mr-3" />
            Matriz Scaling Growth Optimization
          </h2>
          <p className="text-text-secondary">
            Control integral de scaling y optimización de crecimiento.
          </p>
        </div>
