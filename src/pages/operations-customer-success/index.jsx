...
const OperationsCustomerSuccess = () => {
  const kpiData = [
    { title: "Overdue Tasks", value: "4", subtitle: "Tasks past due date", color: "error", icon: "AlertTriangle" },
    { title: "High Priorities", value: "8", subtitle: "Critical tasks pending", color: "warning", icon: "Star" },
    { title: "Upcoming Milestones", value: "2", subtitle: "Due within 30 days", color: "success", icon: "Target" },
  ];
  ...
  return (
    <ACModuleTemplate
      moduleId="AC-006"
      moduleName="Operations & Customer Success"
      moduleDescription="Optimiza operaciones y garantiza el éxito y satisfacción de tus clientes"
      kpiData={kpiData}
      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-soft border border-gray-100">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-text-primary mb-2 flex items-center">
            <Icon name="Settings" size={28} className="text-primary-500 mr-3" />
            Matriz Operations & Customer Success
          </h2>
          <p className="text-text-secondary">
            Control integral de operaciones y éxito del cliente.
          </p>
        </div>
