...
const AC001StrategicFundamentals = () => {
  const kpiData = [
    { title: "Overdue Tasks", value: "6", subtitle: "Tasks past due date", color: "error", icon: "AlertTriangle" },
    { title: "High Priorities", value: "9", subtitle: "Critical tasks pending", color: "warning", icon: "Star" },
  ...
  return (
    <ACModuleTemplate
      moduleId="AC-001"
      moduleName="Fundamentos Estratégicos"
      moduleDescription="Establece la base estratégica sólida para el éxito de tu startup"
      kpiData={kpiData}
      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-soft border border-gray-100">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-text-primary mb-2 flex items-center">
            <Icon name="Compass" size={28} className="text-primary-500 mr-3" />
            Matriz Estratégica Fundamental
          </h2>
          <p className="text-text-secondary">
            Control integral de los fundamentos estratégicos para el éxito de tu startup.
          </p>
        </div>
...
export default AC001StrategicFundamentals; 