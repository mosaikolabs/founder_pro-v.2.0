...
const AC006OperationsSuccess = () => {
  ...
  return (
    <ACModuleTemplate
      moduleId="AC-006"
      moduleName="Operations & Success Management"
      moduleDescription="Optimiza las operaciones y garantiza el éxito del cliente con procesos eficientes"
      kpiData={kpiData}
      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-soft border border-gray-100">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-text-primary mb-2 flex items-center">
            ...
            Matriz Operations & Success
          </h2>
          <p className="text-text-secondary">
            Control integral de operaciones y gestión del éxito del cliente.
          </p>
        </div>
...
export default AC006OperationsSuccess; 