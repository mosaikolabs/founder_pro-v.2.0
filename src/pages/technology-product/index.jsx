...
const AC003TechnologyProduct = () => {
  ...
  return (
    <ACModuleTemplate
      moduleId="AC-003"
      moduleName="Tecnología & Producto"
      moduleDescription="Desarrolla la base tecnológica sólida y producto escalable para tu startup"
      kpiData={kpiData}
      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-soft border border-gray-100">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-text-primary mb-2 flex items-center">
            <Icon name="Code" size={28} className="text-primary-500 mr-3" />
            Matriz Tecnológica & Producto
          </h2>
          <p className="text-text-secondary">
            Control integral del desarrollo tecnológico y roadmap de producto.
          </p>
        </div>
...
export default AC003TechnologyProduct; 