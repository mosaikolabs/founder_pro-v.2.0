...
const AC009ScalingGrowth = () => {
  ...
  return (
    <ACModuleTemplate
      ...
      moduleDescription="Optimiza el escalamiento y crecimiento sostenible de tu startup"
      kpiData={kpiData}
      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-soft border border-gray-100">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-text-primary mb-2 flex items-center">
            ...
            Matriz Scaling & Growth
          </h2>
          <p className="text-text-secondary">
            Control integral de escalamiento y optimización del crecimiento.
          </p>
        </div>
...
export default AC009ScalingGrowth; 