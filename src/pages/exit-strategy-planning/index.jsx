...
const ExitStrategyPlanning = () => {
  const kpiData = [
    { title: "Overdue Tasks", value: "2", subtitle: "Tasks past due date", color: "error", icon: "AlertTriangle" },
    { title: "High Priorities", value: "6", subtitle: "Critical tasks pending", color: "warning", icon: "Star" },
  ...
  return (
    <ACModuleTemplate
      moduleId="AC-010"
      moduleName="Exit Strategy Planning"
      moduleDescription="Planifica tu estrategia de salida y maximiza la valuation de tu startup"
      kpiData={kpiData}
      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-soft border border-gray-100">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-text-primary mb-2 flex items-center">
            <Icon name="Target" size={28} className="text-primary-500 mr-3" />
            Matriz Exit Strategy Planning
          </h2>
          <p className="text-text-secondary">
            Control integral de estrategias de salida y maximización de valuation.
          </p>
        </div>
