...
const AC010ExitStrategy = () => {
  ...
  return (
    <ACModuleTemplate
      ...
      moduleDescription="Planifica estrategias de salida exitosas para tu startup"
      kpiData={kpiData}
      ...
      <div className="bg-gradient-card p-8 rounded-2xl shadow-soft border border-gray-100">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-text-primary mb-2 flex items-center">
            ...
            Matriz Exit Strategy
          </h2>
          <p className="text-text-secondary">
            Control integral de planificación de estrategias de salida.
          </p>
        </div>
...
export default AC010ExitStrategy; 